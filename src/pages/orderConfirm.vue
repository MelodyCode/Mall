...
export default {
    ...
    data() {
        return {
            ...
            cartTotalPrice:0,//购物车中已经选中的商品的总金额
            count:0,//商品结算数量
            checkedItem:{},//选中的商品对象
            userAction:'',//用户行为：新增0，编辑1，删除2
            showDelModal:false,
            showEditModal:false,
            checkIndex:0//当前收货地址默认的索引
        }
    },
    mounted(){
        this.getAddressList();
    ...
    methods: {
        ...
        getCartList() {
            this.axios.get('/carts').then((res) => {
               ...
               //过滤出已经选中的商品productSelected==true
        ...
        //订单提交，注意：购物车的数据进入订单结算，购物车中的数据会被清除
        orderSubmit(){
          //list购物车列表
